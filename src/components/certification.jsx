...
import { SetCertifications } from '../actions/ResumeDataAction';
...
function Certification() {
    ...
    const verfiyCertification = () => {
        ...
        if (description == '') {
            toast('Please enter the description in brief.');
            return;
        }
        ...
        let tempCertifications = [...certifications, newCertificate];
        setCertificationsList(tempCertifications);
        dispatch(SetCertifications(tempCertifications));
        ...
        <Box display='flex' flexDirection='column' justifyContent='center'>
            ...
            {certifications.map(cert => (
                <Box width='30rem' bgcolor={colors.primary[700]} p='1rem' m='0.5rem 2rem'>
                    <Typography fontSize='1.4rem' color={colors.greenAccent[400]}>{cert.title}</Typography>
                    <Typography fontSize='1.3rem' color={colors.primary[200]}>{cert.type}</Typography>
                </Box>
